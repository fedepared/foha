...
namespace Foha.Models{
    ...
    public partial class MegaUltraArchiVista
        {
            ...
            // public DateTime? PrensayugosEnviados {get;set;} 
            // public DateTime? PrensayugosProducidos {get;set;} 
            ...
            // public DateTime? Conex {get;set;} 
            // public DateTime? Horno {get;set;} 
            // public DateTime? CortePlegado {get;set;} 
            // public DateTime? Tapa {get;set;} 
            // public DateTime? Cuba {get;set;} 
            // public DateTime? Radiadores {get;set;} 
            // public DateTime? Tintas {get;set;} 

            // public DateTime? Granallado {get;set;} 
            // public DateTime? Pintura {get;set;} 
            // public DateTime? Encubado {get;set;} 
            // public DateTime? Laboratorio {get;set;} 
            // public DateTime? Hermeticidad {get;set;} 
